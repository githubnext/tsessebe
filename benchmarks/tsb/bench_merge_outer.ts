/**
 * Benchmark: merge(left, right, { how: "outer" }) on 30k-row DataFrames.
 */
...
for (let i = 0; i < WARMUP; i++) merge(left, right, { on: "id", how: "outer" });
...
console.log(JSON.stringify({ function: "merge_outer", mean_ms: total / ITERATIONS, iterations: ITERATIONS, total_ms: total }));
