/**
 * Benchmark: merge(left, right, { how: "right" }) on 50k-row DataFrames.
 */
...
for (let i = 0; i < WARMUP; i++) merge(left, right, { on: "id", how: "right" });
...
console.log(JSON.stringify({ function: "merge_right", mean_ms: total / ITERATIONS, iterations: ITERATIONS, total_ms: total }));
